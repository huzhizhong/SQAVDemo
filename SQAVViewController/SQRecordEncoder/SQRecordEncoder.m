...
@implementation SQRecordEncoder
...
//SQRecordEncoder遍历构造器的
+ (SQRecordEncoder*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate {
    SQRecordEncoder* enc = [SQRecordEncoder alloc];
